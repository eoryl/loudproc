 ...
 */
void __declspec(dllexport) ebur128_get_version(int* major, int* minor, int* patch);
 ...
 */
__declspec(dllexport)  ebur128_state *  ebur128_init(unsigned int channels,
 ...
 */
void __declspec(dllexport) ebur128_destroy(ebur128_state** st);
 ...
 */
int __declspec(dllexport) ebur128_set_channel(ebur128_state* st,
 ...
 */
int __declspec(dllexport) ebur128_change_parameters(ebur128_state* st,
 ...
 */
int __declspec(dllexport) ebur128_set_max_window(ebur128_state* st, unsigned long window);
 ...
 */
int __declspec(dllexport) ebur128_set_max_history(ebur128_state* st, unsigned long history);
 ...
 */
int __declspec(dllexport) ebur128_add_frames_short(ebur128_state* st,
                             const short* src,
                             size_t frames);
/** \brief See \ref ebur128_add_frames_short */
int __declspec(dllexport) ebur128_add_frames_int(ebur128_state* st,
                             const int* src,
                             size_t frames);
/** \brief See \ref ebur128_add_frames_short */
int __declspec(dllexport) ebur128_add_frames_float(ebur128_state* st,
                             const float* src,
                             size_t frames);
/** \brief See \ref ebur128_add_frames_short */
int __declspec(dllexport) ebur128_add_frames_double(ebur128_state* st,
                             const double* src,
                             size_t frames);
 ...
 */
int __declspec(dllexport) ebur128_loudness_global(ebur128_state* st, double* out);
 ...
 *    - EBUR128_ERROR_INVALID_MODE if mode "EBUR128_MODE_I" has not been set.
 */
int __declspec(dllexport) ebur128_loudness_global_multiple(ebur128_state** sts,
                                     size_t size,
                                     double* out);
 ...
 *    - EBUR128_SUCCESS on success.
 */
int __declspec(dllexport) ebur128_loudness_momentary(ebur128_state* st, double* out);
 ...
 */
int __declspec(dllexport) ebur128_loudness_shortterm(ebur128_state* st, double* out);
 ...
 */
int __declspec(dllexport) ebur128_loudness_window(ebur128_state* st,
 ...
 */
int __declspec(dllexport) ebur128_loudness_range(ebur128_state* st, double* out);
 ...
 *    - EBUR128_ERROR_INVALID_MODE if mode "EBUR128_MODE_LRA" has not been set.
 */
int __declspec(dllexport) ebur128_loudness_range_multiple(ebur128_state** sts,
                                    size_t size,
                                    double* out);
 ...
 *    - EBUR128_ERROR_INVALID_CHANNEL_INDEX if invalid channel index.
 */
int __declspec(dllexport) ebur128_sample_peak(ebur128_state* st,
                        unsigned int channel_number,
                        double* out);
 ...
 *    - EBUR128_ERROR_INVALID_CHANNEL_INDEX if invalid channel index.
 */
int __declspec(dllexport) ebur128_prev_sample_peak(ebur128_state* st,
                             unsigned int channel_number,
                             double* out);
 ...
 *    - EBUR128_ERROR_INVALID_CHANNEL_INDEX if invalid channel index.
 */
int __declspec(dllexport) ebur128_true_peak(ebur128_state* st,
                      unsigned int channel_number,
                      double* out);
 ...
 *    - EBUR128_ERROR_INVALID_CHANNEL_INDEX if invalid channel index.
 */
int __declspec(dllexport) ebur128_prev_true_peak(ebur128_state* st,
                           unsigned int channel_number,
                           double* out);
 ...
 *      been set.
 */
int __declspec(dllexport) ebur128_relative_threshold(ebur128_state* st, double* out);
